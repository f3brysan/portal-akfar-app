      ...
      <div class="card">
        ...
        <form role="form" action="" method="post" enctype="multipart/form-data">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control float-right form_date" name="event_start" value="<?php echo $get->event_start; ?>" data-date-format="yyyy-mm-dd" id="form_date">
              </div>
              <!-- /.input group -->
            </div>
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control float-right form_date" name="event_end" value="<?php echo $get->event_end ?>" data-date-format="yyyy-mm-dd" id="form_date">
              </div>
              <!-- /.input group -->
            </div>                                    
                </div>
