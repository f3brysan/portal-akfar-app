        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Ubah Data Riwayat Pendidikan</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Ubah Data Dosen Baru</h3>          
        </div>
        <form role="form" action="" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">                    
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="jenjang" placeholder="Jenjang Pendidikan" value="<?php echo $pendidikan->jenjang; ?>">
                  </div>                 
                  <div class="form-group">
                    <label for="exampleInputEmail1">Nama Institusi</label>
                    <input type="text" class="form-control" name="institusi" placeholder="Nama Institusi Pendidikan" value="<?php echo $pendidikan->institusi; ?>">
                  </div>                  
                  <div class="form-group">
                    <label for="exampleInputEmail1">Tahun Mulai</label>
                    <input type="text" class="form-control" name="mulai" placeholder="Tahun Mulai" value="<?php echo $pendidikan->mulai; ?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Tahun Selesai</label>
                    <input type="text" class="form-control" name="selesai" placeholder="Tahun Selesai" value="<?php echo $pendidikan->selesai; ?>">
                  </div>                                                                  
                </div>
                <!-- /.card-body -->
