        ...
        <div class="row">
          ...
          <div class="col-sm-12 col-md-3">
            <div class="sidebar sidebar-left mt-sm-30">              
              <div class="widget">
                <h5 class="widget-title line-bottom">Unit Kegiatan Mahasiswa</h5>
                <div class="categories">
                  <ul class="list list-border angle-double-right">
                    <?php foreach ($all_akademik as $a): ?>
                    <li><a href="<?php echo site_url("home/ukm/$a[code]/$a[hyperlink]") ?>"><?php echo $a['title'] ?></a></l>                 
                    <?php endforeach ?>
                  </ul>
                </div>
              </div>                            
