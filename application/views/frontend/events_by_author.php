  ...
  <div class="main-content">
          ...
          <div class="row">
            <div class="col-md-12">
              <h2 class="title text-white">
                <?php foreach ($author_events as $h2): ?>
                Agenda oleh <?php echo ucfirst($h2['author']); ?></h2>              
              <ol class="breadcrumb text-left text-black mt-10">
                <li><a href="<?php echo site_url('home') ?>">Beranda</a></li>
                <li><a href="<?php echo site_url('home/events') ?>">Agenda</a></li>
                <li class="active text-gray-silver">Agenda oleh <?php echo ucfirst($h2['author']); ?></li>               
              </ol>
               <?php endforeach ?>
            </div>
          </div>
    ...
    <section>
      <div class="container">
        <div class="row">
          <div class="col-md-9">
            <?php if (is_array($author_events) && count($author_events) > 0): ?>
              <?php foreach ($author_events as $event): ?>
